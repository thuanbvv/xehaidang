                        ...
                        <div class="col-lg-8 col-md-8">
                            <div class="left-content">
                                <div class="shadow p-lg mb-xlg">
                                    <div class="model row">
                                        <div class="col-sm-6"><a><img src="public/uploads/product/<?php echo $dsproductId['thunbar']?>"></a></div>
                                        <div class="col-sm-6">
                                            <div class="tit3 mt-md mb-xs"><?php echo $dsproductId['name']?></div>
                                            <div class="stars large mb-md">
                                                <img src="public/frontend/Images/star-on.png" style="width: 25px;height: 25px;" alt="vehicle">
                                                <img src="public/frontend/Images/star-on.png" style="width: 25px;height: 25px;" alt="vehicle">
                                                <img src="public/frontend/Images/star-on.png" style="width: 25px;height: 25px;" alt="vehicle">
                                                <img src="public/frontend/Images/star-on.png" style="width: 25px;height: 25px;" alt="vehicle">
                                                <img src="public/frontend/Images/star-off.png" style="width: 25px;height: 25px;" alt="vehicle">
                                            </div>
                                            <div class="info mb-none" style="margin-top: 20px;">
                                                <div style="float:left;width: 49%;margin: 5px 0">
                                                    <img src="public/frontend/Images/ic-fuel.png" class="vhc_icon" style="width: 20px;height: 20px;margin-right: 10px"><span>Xăng</span>
                                                </div>
                                                <div style="float:left;width: 49%;margin: 5px 0"> <img style="width: 20px;height: 20px;margin-right: 10px" src="public/frontend/Images/piston.png" class="vhc_icon"><span>1.2L</span></div>
                                                <div style="float:left;width: 49%;margin: 5px 0"> <img style="width: 20px;height: 20px;margin-right: 10px" src="public/frontend/Images/ic-tms.png" class="vhc_icon"><span>Số tự động</span></div>
                                                <div style="float:left;width: 49%;margin: 5px 0"> <img style="width: 20px;height: 20px;margin-right: 10px" src="public/frontend/Images/ic-seat.png" class="vhc_icon"><span><?php echo $sqlsocho ?> chỗ</span></div>
                                                <div style="float:left;width: 49%;margin: 5px 0"> <img style="width: 20px;height: 20px;margin-right: 10px" src="public/frontend/Images/ic-car.png" class="vhc_icon"><span>Hatchback</span></div>
                                                <div style="float:left;width: 49%;margin: 5px 0"> <img style="width: 20px;height: 20px;margin-right: 10px" src="public/frontend/Images/gauge.png" class="vhc_icon"><span>8l/100km</span></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-xlg">
                                        <div class="col-md-12">
                                            ...
                                            <div class="mb-md">
                                                ...
                                                <div class="row i-lg">
                                                    <div class="col-lg-4 col-md-6 mb-md"><img src="public/frontend/Images/ic-brakes.png" alt="Điều hoà (A/C) " class="vhc_icon"><span>Điều hoà (A/C) </span></div>
                                                    <div class="col-lg-4 col-md-6 mb-md"><img src="public/frontend/Images/ic-gprs.png" alt="Định vị (GPS) " class="vhc_icon"><span>Định vị (GPS) </span></div>
                                                    <div class="col-lg-4 col-md-6 mb-md"><img src="public/frontend/Images/ic-bluetooth.png" alt="Bluetooth " class="vhc_icon"><span>Bluetooth </span></div>
                                                    <div class="col-lg-4 col-md-6 mb-md"><img src="public/frontend/Images/ic-usb.png" alt="Khe cắm USB" class="vhc_icon"><span>Khe cắm USB</span></div>
                                                </div>
                                            </div>
                                            <div class="mb-md">
                                                <div class="b-tit">THỦ TỤC</div>
                                                <div class="row i-lg">
                                                    <div class="col-lg-4 col-md-6 mb-md"><span style="float: left;"><img src="public/frontend/Images/CMND.png" alt="procedure" class="vhc_icon"></span><span style="float: left; width: auto;">CMND</span></div>
                                                    <div class="col-lg-4 col-md-6 mb-md"><span style="float: left;"><img src="public/frontend/Images/ic-cmnd.png" alt="procedure" class="vhc_icon"></span><span style="float: left; width: auto;">Sổ hộ khẩu</span></div>
                                                    <div class="col-lg-4 col-md-6 mb-md"><span style="float: left;"><img src="public/frontend/Images/banglai.png" alt="procedure" class="vhc_icon"></span><span style="float: left; width: auto;">Bằng lái</span></div>
                                                    <div class="col-lg-4 col-md-6 mb-md"><span style="float: left;"><img src="public/frontend/Images/ic-money.png" alt="procedure" class="vhc_icon"></span><span style="float: left; width: auto;">Đặt cọc</span></div>
                                                </div>
                                            </div>
                                            <div class="mb-md">
                                                <div class="b-tit">CHẤP NHẬN THANH TOÁN</div>
                                                <div class="row i-lg">
                                                    <div class="col-lg-4 col-md-6 mb-md"><span style="float: left;"><img src="public/frontend/Images/ic-money.png" alt="payment" class="vhc_icon"></span><span style="float: left; width: 73%;">Trả sau</span></div>
                                                </div>
                                            </div>
                                            <div class="mb-md">
                                    ...
                                    <div class="pr text-center">GIÁ VÀ THỦ TỤC</div>
                                     <form  class="cap form-horizontal" action="" method="POST" enctype="multipart/form-data">
                                         ...
                                         <div class="form-group  position-relative form-group">
                                             ...
                                             <div class="form-control-static pt-none"><span style="float: none; font-weight: normal;">Tối đa 250km/ngày</span><span style="float: none; font-weight: normal; text-transform: lowercase;">, Phụ trội 30.000 đ/km </span></div>
                                         </div>
                                         ...
                                         <div class="form-group mb-none position-relative form-group">
                                             ...
                                             <p style="color: red; font-weight: bold;" class="form-control-static p-none">Đơn giá ngày <span><?php echo formatPrice($dsproductId['price'])?> vnđ</span></p>
                                         ...
                                         <div class="btn btn-block mt-md" style="background: linear-gradient(to right, rgb(15, 149, 155), rgb(6, 74, 80)); color: rgb(255, 255, 255); padding: 14px 1.2rem; border: none; min-width: 150px; font-weight: 500;">
