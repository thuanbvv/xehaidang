    ...
    <div class="col-md-12">
        <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
		    <div class="form-group">
		        ...
		        <div class="col-sm-8">
		        	<input type="text" class="form-control" id="inputEmai13" placeholder="Tiêu đề tin" name="p_title" value="<?php echo $editnews['p_title'] ?>">
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-sm-8">
		        	...
		        	<?php endif ?>
                    <img src="<?= base_url()?>/public/uploads/tin-tuc/<?php echo $editnews['p_thunbar']?>" alt="" style="width: 80px;height: 80px;">
		    	</div>
		    </div>
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-sm-8">
		        	<textarea cols="80" id="editor1" name="p_content" rows="10" data-sample-short><?php echo $editnews['p_content']?></textarea>
		        	  <script>
