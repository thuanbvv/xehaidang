    ...
    <div class="col-md-12">
        <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
		     <div class="form-group">
		        ...
		        <div class="col-sm-3">
		        	<input type="text" class="form-control" id="inputEmai13" placeholder="Tên Hình" name="name" value="<?php echo $editslide['name']?>">
		        ...
		        <div class="col-sm-2">
		        	...
		        	<?php endif ?>
		        	<img width="50px" height="50px" src="<?php echo uploads() ?>slide/<?php echo $editslide['thunbar'] ?>">
		    	</div>
		    </div>
		    <div class="form-group">
