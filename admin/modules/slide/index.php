                    ...
                    <?php $stt=1; foreach ($slide as $item) : ?>
                        <tr>
                            ...
                            <td><?php echo $item['name']?></td>
                             <td><img src="<?php echo uploads() ?>slide/<?php echo $item['thunbar']?>" width="50px" height="50px" ></td>
                            ...
                            <td>
                                <a href="" class="btn btn-xs <?php echo $item['active_slide']=="active" ? 'btn-default' : 'btn-info' ?>" >
                                    <i class="fa fa-edit"></i>
