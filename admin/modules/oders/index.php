                ...
                <tbody>
                    <?php $stt=1; foreach ($product as $item) : ?>
                        <tr>
                            ...
                            <td><img src="<?php echo uploads() ?>product/<?php echo $item['thunbar']?>" width="50px" height="50px" ></td>
                            <td>
                                <ul>
                                    <li>Giá: <?php echo $item['price'] ?></li>
                                    <li>Số Lương: <?php echo $item['number'] ?></li>
                                    <li>Giá giảm: <?php echo $item['sale'] ?> - Thành tiền giảm: <?php echo $item['price']-$item['sale']*$item['price']/100 ?> </li>
                                </ul>
                            </td>
                            <td>
