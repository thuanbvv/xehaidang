    ...
    <div class="col-md-12">
        <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-sm-8">
		        	<input type="text" class="form-control" id="inputEmai13" placeholder="Tên Sản Phẩm" name="name" value="<?php echo $editproduct['name']?>">
		     ...
		     <div class="form-group">
		        ...
		        <div class="col-sm-8">
		        	<input type="number" class="form-control" id="inputEmai13" placeholder="9.000.000" name="price" value="<?php echo $editproduct['price']?>">
		     ...
		     <div class="form-group">
		        ...
		        <div class="col-sm-8">
		        	<input type="number" class="form-control" id="inputEmai13" placeholder="100" name="number" value="<?php echo $editproduct['number']?>">
		     ...
		     <div class="form-group">
		        ...
		        <div class="col-sm-3">
		        	<input type="number" class="form-control" id="inputEmai13" placeholder="9.000.000" name="sale" value="<?php echo $editproduct['sale']?>">
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-sm-8">
		        	<input type="text" class="form-control" id="inputEmai13" placeholder="Mã Sản Phẩm" name="masp" value="<?php echo $editproduct['masp']?>">
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-sm-8">
		        	<input type="text" class="form-control" id="inputEmai13" placeholder="Chất liệu Sản Phẩm" name="chatlieu" value="<?php echo $editproduct['chatlieu']?>">
		     ...
		     <div class="form-group">
		        ...
		        <div class="col-sm-8">
		        	<input type="text" class="form-control" id="inputEmai13" placeholder="Màu sắc Sản Phẩm" name="color" value="<?php echo $editproduct['color']?>">
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-sm-8">
		        	<input type="text" class="form-control" id="inputEmai13" placeholder="Kích thước Sản Phẩm" name="kichthuoc" value="<?php echo $editproduct['kichthuoc']?>">
		   ...
		   <div class="form-group">
		        ...
		        <div class="col-sm-8">
		        	<input type="text" class="form-control" id="inputEmai13" placeholder="Xuất sứ Sản Phẩm" name="xuatxu" value="<?php echo $editproduct['xuatxu']?>">
		    ...
		    <script src="https://cdn.ckeditor.com/4.12.1/standard-all/ckeditor.js"></script>
		     <div class="form-group">
		       <label for="inputEmai13" class="col-sm-2 control-label">Nội dung sản phẩm</label>
		        <div class="col-sm-8">
		        	<textarea cols="80" id="editor1" name="content" rows="10" data-sample-short><?php echo $editproduct['content']?></textarea>
		        	  <script>
