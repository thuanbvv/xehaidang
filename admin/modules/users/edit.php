    ...
    <div class="col-md-12">
        <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
		    <div class="form-group">
		        ...
		        <div class="col-sm-8">
		        	<input type="text" class="form-control" id="inputEmai13" placeholder="Họ và Tên" name="name" value="<?php echo $editusers['name'] ?>">
		     ...
		     <div class="form-group">
		        ...
		        <div class="col-sm-8">
		        	<input type="email" class="form-control" id="inputEmai13" placeholder="congtoan.it.ltv@gmail.com" name="email" value="<?php echo $editusers['email']?>" >
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-sm-8">
		        	<input type="number" class="form-control" id="inputEmai13" placeholder="0909943262" name="phone" value="<?php echo $editusers['phone']?>">
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-sm-8">
		        	<input type="password" class="form-control" id="inputEmai13" placeholder="********" name="password" value="<?php echo $editusers['password']?>">
		    ...
		    <div class="form-group">
		        ...
		        <div class="col-sm-8">
		        	<input type="text" class="form-control" id="inputEmai13" placeholder="địa chỉ" name="adress" value="<?php echo $editusers['adress']?>">
