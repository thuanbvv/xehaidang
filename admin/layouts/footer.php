...
<script src="<?= base_url() ?>public/admin/js/jquery-1.10.2.js"></script>
...
<!--    <script src="--><? //= base_url() ?><!--public/admin/js/sb-admin.js"></script>-->

<!-- Page-Level Demo Scripts - Dashboard - Use for reference -->
<!--    <script src="--><? //= base_url() ?><!--public/admin/js/demo/dashboard-demo.js"></script>-->
