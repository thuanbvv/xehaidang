                        ...
                        <div class="row" >
                            <div class="col-md-12" >
                                ...
                                <ul class="nav navbar-nav navbar-right topmenu  hidden-xs hidden-sm">
                                    <li><a style="margin-top: 2px;height: 29px;" href="tro-thanh-doi-tac.php" class="btn btn-primary" role="button" >Trở thành đối tác</a></li>
                                    ...
                                    <div class="quick-user">
                                        ...
                                        <div class="inner-toggle">
                                            <ul class="login links">
                                                <?php if(isset($_SESSION['name_user'])) :?>
                                                    <li>
                                                        <a href="dang-xuat.php"><i class="fa fa-sign-in"></i> Xin Chào : <?= $_SESSION['name_user'] ?></a>
                                                    </li>
                                    ...
                                    <div class="search_box">
                                        <div class="search_wrapper">
                                            <form action="/tim-kiem.php">
                                                <input type="text" name="k" value="<?= getInput('k') ?>" class="index_input_search"  />
                                        ...
                                        <div id="menuverti" class="block_content navbar_menuvertical">
                                            <ul class="nav_verticalmenu" style="display: none;">
                                                ...
                                                <li class="has-child level0">
                                                    <a class="" href="san-pham.php?danh-muc=<?= $value['id'] ?>"><img class="icon-menu" src="public/frontend/Uploads/logo.png" alt="">
