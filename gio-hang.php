          ...
          <?php if (isset($_SESSION['success'])): ?>
                ...
                <table class="table table-hover" id="shoppingcart_info">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            	<img src="public/uploads/product/<?php echo $value['thunbar'] ?>" width="80px" height ="100px" alt="">
                            </td>
                            <td>
                            ...
                            <td><?php echo fomatprice($value['price'] * $value['qty']) ?></td>
                             <td>
                             	<a href="remote.php?key=<?php echo $key ?>" class="btn btn-xs btn-danger"><i class="fa fa-remove"></i> Gỡ</a>
                ...
                <div class="col-md-5 pull-right">
                    <ul class="list-group"> 
                        ...
                        <li class="list-group-item">
                            <span class="badge"><?php $_SESSION['total'] = $_SESSION['tongtien']; echo fomatprice($_SESSION['total']) ?></span>
